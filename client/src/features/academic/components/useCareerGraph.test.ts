...
describe('useCareerGraph hook', () => {
    ...
    it('deberí­a manejar errores de red y desactivar el loading', async () => {
    ...
    it('handleSaveSubject deberí­a enviar la peticií³n y recargar el grafo silenciosamente', async () => {
        (academicApi.fetchAcademicGraph as any).mockResolvedValue([mockSubject]);
