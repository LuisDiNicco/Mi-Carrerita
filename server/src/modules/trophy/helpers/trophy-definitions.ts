...
export const TROPHY_DEFINITIONS: TrophySeedDefinition[] = [
  ...
  },
  {
    code: 'COMEBACK_PASS',
    name: 'Resurrección',
    description: 'Pasar una materia después de un 0',
    tier: TrophyTier.BRONZE,
    icon: 'https://via.placeholder.com/64?text=Comeback',
    rarity: 40,
    criteria: 'Pass a subject after failing it once',
  },
  {
  ...
  {
    code: 'SUBJECT_RETRY_SUCCESS',
    name: 'Perseverancia',
    description: 'Pasar una materia al 3er intento',
    tier: TrophyTier.BRONZE,
    icon: 'https://via.placeholder.com/64?text=Retry',
    rarity: 25,
    criteria: 'Pass a subject after multiple attempts',
  },
  {
